...
function SellersChatsLayout() {
  ...
  return (
    <div className="flex m-5 w-full bg-white rounded-md drop-shadow-sm ">
      <div className="flex border-r border-neutral-100 flex-col basis-3/12  ">
        ...
        <div className="flex items-center m-5 bg-blue-50 mt-0 rounded-md overflow-hidden">
          ...
          <input
            ...
            className="py-2 rounded-lg bg-inherit transition-all  outline-none"
            type="text"
          />
        </div>
            ...
            chats.map((chat: IChat) => {
              ...
              return (
                <div
                  key={chat._id}
                  onClick={() =>
                    navigate(`/account/chats/${chat._id}`, { state: { chat } })
                  }
