...
function ChangeAddressPortal({
  isChangeAddress,
  setIsChangeAddress,
  setAddress,
}: IChangeAddressPortal) {
  ...
  return (
    <>
      {isChangeAddress && (
        <div className="ab p-6 w-[90vw] h-[80vh] border rounded-lg fixed top-1/2 left-1/2 z-50 -translate-x-1/2 -translate-y-1/2  bg-white container">
          <div
          ...
          <div className="gap-3 | flex flex-col overflow-y-scroll">
            {addresses.map((address: IAddress) => (
              <div
                ...
                className="c6 gap-1 | flex items-center bg-slate-50 rounded-lg cursor-pointer "
              >
